...
public class FlightController {
    ...
    public String identifyFlight(HttpServletRequest request, Model model) {
        ...
        String username = (String) request.getAttribute("username");//The username is set in the JwtFilter using request.setAttribute() and later retrieved in the controller from the same request object.
    ...
    // 🔹 Search by route
        ...
        model.addAttribute("flights",
                flightService.findByRoute(source, destination));
    }
